package com.example.cvtheque.security.config;

import com.example.cvtheque.security.filter.JwtAuthenticationFilter;
import com.example.cvtheque.security.filter.JwtAutorisationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/v1/api/authentication/**").permitAll()
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
